...
class LiberoInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        base_image = _parse_image(in_images.get("base_0_rgb", data.get("observation/image", np.zeros((224, 224, 3), dtype=np.uint8))))
        wrist_image = _parse_image(in_images.get("left_wrist_0_rgb", data.get("observation/wrist_image", np.zeros_like(base_image))))
